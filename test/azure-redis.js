    ...
    describe('Redis - Basic - C1', () => {
        describe('Existing Resource Group', () => {
            ...
            it('Creates the right output values', () => {
                ...
                assert.fileContent('output.tf.json', '"${azurerm_redis_cache.cloudcommons.primary_access_key}"');
                assert.fileContent('output.tf.json', '"REDIS_SECONDARY_KEY":');
                assert.fileContent('output.tf.json', '"${azurerm_redis_cache.cloudcommons.secondary_access_key}"');
